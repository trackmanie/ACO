...
public class IHMImpl implements IHM
{
	...
	public void setButtons() {
		...
		setButton("enregistrer", enregistrer);
		setButton("arreter", arreter);
		setButton("rejouer", rejouer);
	}
	...
	public void setCommands(HashMap<String, Command> h) throws Exception {
		...
		if (this.enregistrer == null) throw new Exception("erreur commande \"enregistrer\"");
		this.arreter = h.get("arreter");
		if (this.arreter == null) throw new Exception("erreur commande \"arreter\"");
		this.rejouer = h.get("rejouer");
		if (this.rejouer == null) throw new Exception("erreur commande \"rejouer\"");
		}
